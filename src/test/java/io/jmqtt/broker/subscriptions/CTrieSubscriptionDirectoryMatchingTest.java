...
import io.jmqtt.broker.ISubscriptionsRepository;
...
public class CTrieSubscriptionDirectoryMatchingTest {
    ...
    public void testMatchingDeepMulti_one_layer() {
        ...
        // Verify
        assertThat(sut.matchWithoutQosSharpening(Topic.asTopic("finance/stock")))
            .containsExactlyInAnyOrder(financeAnySub, anySub);
        assertThat(sut.matchWithoutQosSharpening(Topic.asTopic("finance/stock/ibm")))
            .containsExactlyInAnyOrder(financeAnySub, anySub);
//        System.out.println(sut.dumpTree());
    ...
    private void assertMatch(String s, String t) {
        ...
        assertThat(sut.matchWithoutQosSharpening(Topic.asTopic(t))).isNotEmpty();
    }
    ...
    private void assertNotMatch(String subscription, String topic) {
        ...
        assertThat(sut.matchWithoutQosSharpening(Topic.asTopic(topic))).isEmpty();
    }
