...
//            int callCount = 0;
        ...
        m_Main_server.startServer(m_config, ConnectionTestUtils.EMPTY_OBSERVERS, null, new AcceptAllAuthenticator(), switchingAuthorizator);
    }
    ...
    public void shouldNotInternalPublishOnReadBlockedSubscriptionTopic() throws Exception {
        ...
        m_Main_server.internalPublish(message, "INTRLPUB");
