 ...
 * </p>
 */
public class MainServerIntegrationSSLClientAuthTest {

    private static final Logger LOG = LoggerFactory.getLogger(MainServerIntegrationSSLClientAuthTest.class);
    ...
    protected void startServer() throws IOException {
        ...
        m_Main_server.startServer(sslProps);
    }
