...
import io.jmqtt.testclient.Client;
...
public class MainServerLowlevelMessagesIntegrationTests {

    private static final Logger LOG = LoggerFactory.getLogger(MainServerLowlevelMessagesIntegrationTests.class);
