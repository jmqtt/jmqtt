...
public class MainServerIntegrationPahoTest {

    private static final Logger LOG = LoggerFactory.getLogger(MainServerIntegrationPahoTest.class);
    ...
    public void testCleanSession_maintainClientSubscriptions_withServerRestart() throws Exception {
        ...
        m_Main_server.startServer(IntegrationUtils.prepareTestProperties());
