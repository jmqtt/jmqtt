...
import io.jmqtt.broker.NettyUtils;
...
//        reporter.start(1, TimeUnit.MINUTES);
        final String email = props.getProperty(BrokerConstants.METRICS_LIBRATO_EMAIL_PROPERTY_NAME);
        final String token = props.getProperty(BrokerConstants.METRICS_LIBRATO_TOKEN_PROPERTY_NAME);
        final String source = props.getProperty(BrokerConstants.METRICS_LIBRATO_SOURCE_PROPERTY_NAME);
