...
import io.jmqtt.SslHandlerUtils;
 ...
 */
//public class MqttTcpSSLChannelInitializer extends ChannelInitializer<SocketChannel> {
//    @Resource
...
//        pipeline.addLast("ssl", SslHandlerUtils.createSslHandler(socketChannel, sslContext, needsClientAuth));
